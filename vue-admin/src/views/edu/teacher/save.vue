    ...
    <el-form label-width="120px">
      ...
      <el-form-item label="讲师头衔">
        <el-select v-model="teacher.level" clearable placeholder="请选择">
          <!-- 这里 value 使用 level 值（最终将数据提交到后端接口），label 使用 level 对应的称号 -->
...
export default {
  ...
  data() {
    return {
      ...
      imagecropperShow: false, // 头像上传弹窗是否显示
      imagecropperKey: 0,      // 上传组件的 key 值
      BASE_API: process.env.BASE_API, // 接口 API 地址（dev.env.js 中的配置值）
